...
async function main(): Promise<void> {
  ...
  const filteredKeywordsPath = path.join(__dirname, '../data/filtered-keywords.json');
  ...
  const outputPath = path.join(__dirname, '../output/social-posts.json');
  ...
  console.log(`💾 Results saved to google-trends-workflow/output/social-posts.json`);
}

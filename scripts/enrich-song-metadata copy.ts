...
const USING_VERCEL_GATEWAY = false || Boolean(process.env.VERCEL_AI_GATEWAY_API_KEY)
const ENRICHMENT_MODEL = process.env.ENRICHMENT_MODEL || (USING_VERCEL_GATEWAY ? 'openai/gpt-4o-mini' : 'gpt-4o-mini')
const TRANSLATION_MODEL = process.env.TRANSLATION_MODEL || (USING_VERCEL_GATEWAY ? 'openai/gpt-4o-mini' : 'gpt-4o-mini')
